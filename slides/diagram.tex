...
\newcommand{\WordEmbeddingNeighborDiagram}{%
  \begin{tikzpicture}[font=\small]
    ...
    \coordinate (nnMid) at ($(droneEmbStart.east)!0.5!(smartEmbStart-5.east)+(3.7cm,-1.25cm)$);
...
\begin{frame}{LLM Capabilities}
  \centering
  \resizebox{!}{0.85\textheight}{\LLMPipelineDiagram}
\end{frame}
...
\begin{frame}{Embedding Neighbors Task}
  \begin{center}
  \WordEmbeddingNeighborDiagram
  \end{center}
